...
@WebServlet(value = "/FirmServletRevise")
public class FirmServletRevise extends HttpServlet {
    @Override
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Brand brand = firmMapper.SelectById(id);

        request.setAttribute("brand", brand);
        request.getRequestDispatcher("/FirmJSP/FirmUpdata.jsp").forward(request, response);
    }
}
